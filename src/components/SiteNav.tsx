...
export const navItems: NavItem[] = [
  ...
  { to: "/planner/gifts", label: "Gifts", desc: "People, presents and progress — all in one place.", auth: true, match: ["/planner/gifts", "/planner/people", "/planner/list"] },
  ...
  { to: "/planner/outings", label: "Events", desc: "Markets, parties, grottos and days out.", auth: true, match: ["/planner/outings", "/days-out"] },
