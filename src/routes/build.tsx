...
function buildCards(choices: Choices): { tag: string; title: string; desc: string; to: string }[] {
  ...
  if (all || wants.has("presents") || people.length > 0) {
    push({ tag: "For your people", title: "My Christmas Gifts", desc: "Add everyone you're buying for and keep every gift idea, budget and wrap safely in one place.", to: "/planner/gifts" }, 1);
  }
