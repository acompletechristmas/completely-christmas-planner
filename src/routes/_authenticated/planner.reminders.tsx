...
function RemindersPage() {
  ...
  return (
    <div className="rise-in space-y-6">
      {/* Header card */}
      <div className="relative overflow-hidden rounded-3xl border border-[oklch(0.80_0.14_85_/_0.3)] bg-[color:var(--surface-card)] p-6 sm:p-8">
        <div
          aria-hidden="true"
...
function ReminderItem({
  ...
  return (
    <li
      className={
        "rounded-xl border bg-[color:var(--surface-card)] transition " +
        (row.done
      ...
      {expanded ? (
        <div className="grid gap-3 border-t border-[oklch(0.80_0.14_85_/_0.12)] px-4 py-3 sm:grid-cols-[1fr_auto]">
          <input
            ...
            className="min-w-0 rounded-lg border border-[oklch(0.80_0.14_85_/_0.2)] bg-[color:var(--surface-card)] px-3 py-2 text-sm outline-none focus:border-[oklch(0.80_0.14_85_/_0.6)]"
          />
          <input
            type="date"
            value={row.remind_on}
            onChange={(e) => onDate(e.target.value)}
            className="rounded-lg border border-[oklch(0.80_0.14_85_/_0.2)] bg-[color:var(--surface-card)] px-3 py-2 text-sm text-muted-foreground outline-none focus:border-[oklch(0.80_0.14_85_/_0.6)]"
          />
          <textarea
            value={row.notes ?? ""}
            ...
            rows={2}
            className="sm:col-span-2 rounded-lg border border-[oklch(0.80_0.14_85_/_0.15)] bg-[color:var(--surface-card)] px-3 py-2 text-sm outline-none focus:border-[oklch(0.80_0.14_85_/_0.6)]"
          />
        </div>
      ) : null}
    </li>
...
function Stat({ label, value, tone = "muted" }: { label: string; value: string; tone?: "muted" | "ember" }) {
  return (
    <div
      className={
        "rounded-xl border bg-[color:var(--surface-card)] px-4 py-3 " +
        (tone === "ember"
