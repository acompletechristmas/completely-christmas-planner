  ...
  return (
    <div className="rise-in space-y-6">
      ...
      {loading ? (
        ...
        <div className="overflow-hidden rounded-2xl border border-[oklch(0.80_0.14_85_/_0.2)] bg-[color:var(--surface-card)]">
          <ul>
            {rows.map((row) => (
              <li
                key={row.id}
              ...
              >
                <input
                  ...
                  className="rounded-lg border border-transparent bg-[color:var(--surface-card)] px-3 py-2 text-sm outline-none hover:border-[oklch(0.80_0.14_85_/_0.2)] focus:border-[oklch(0.80_0.14_85_/_0.6)]"
                />
                <input
                  value={row.address ?? ""}
